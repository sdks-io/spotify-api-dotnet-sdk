...
| `TempoConfidence` | `double?` | Optional | The confidence, from 0.0 to 1.0, of the reliability of the `tempo`.<br>**Constraints**: `>= 0`, `<= 1` |
...
| `TimeSignatureConfidence` | `double?` | Optional | The confidence, from 0.0 to 1.0, of the reliability of the `time_signature`.<br>**Constraints**: `>= 0`, `<= 1` |
...
| `KeyConfidence` | `double?` | Optional | The confidence, from 0.0 to 1.0, of the reliability of the `key`.<br>**Constraints**: `>= 0`, `<= 1` |
